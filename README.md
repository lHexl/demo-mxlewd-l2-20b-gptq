...
# Banana.dev MXLewd-L2-20B-GPTQ starter template

This is a MXLewd-L2-20B-GPTQ starter template from [Banana.dev](https://www.banana.dev) that allows on-demand serverless GPU inference.
...
1. [Fork this](https://github.com/yachty66/demo-mxlewd-l2-20b-gptq/fork) repository to your own Github account.
